...
<body class="admin-bg min-h-screen flex flex-col">
    ...
    <div class="flex flex-1 relative">
        ...
        <aside id="sidebar" class="bg-admin-primary text-white w-64 md:block fixed md:relative inset-y-0 md:inset-y-auto left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out md:h-auto z-30 md:min-h-full shadow-lg">
        ...
        <main class="flex-1 overflow-y-auto p-4 md:p-6">
            ...
            <?php if (App\core\Application::$app->session->getFlash('info')): ?>
                <div class="mb-4">
                    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4" role="alert">
                        <p><?= App\core\Application::$app->session->getFlash('info') ?></p>
                    </div>
                </div>
            <?php endif; ?>
