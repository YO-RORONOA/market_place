        ...
        <div class="p-6">
            <?php $form = Form::begin('', 'post'); ?>
                ...
                <div class="flex items-center justify-between mt-4">
                    <div class="flex items-center">
                        <input id="remember_me" name="remember_me" type="checkbox" class="h-4 w-4 text-accent-teal focus:ring-accent-teal border-gray-300 rounded">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="/register" class="font-medium text-accent-ceramicblue hover:text-accent-teal">
                        Sign up
                    </a>
                </p>
            </div>
